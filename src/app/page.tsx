          ...
          <div id="content-scroll">
            ...
            <div id="main">
              ...
              <div id="main-content">
                ...
                <div className="weknowpain-main-outer">
                  <div className="weknowpain-main">
                    <div className="experience-show">
                      <div className="experience-middle-container">
                        <div className="experience-middle section-heading we-know-your-pain-heading text-center weknowpain-main-heading">
                          we understand your pain
                        </div>
                      </div>
                    </div>
                    <div className="section-heading text-center painheading">
                      we understand your pain
                    </div>
                  </div>
                </div>
                ...
                <div className="we-know-your-pain-sec">
                  <div id="gallery" className="we-know-your-pain-lists">
                    <div id="scroller">
                      <div className="splide">
                        <div className="splide__track" id="splide-track">
                          <ul className="splide__list align-items-center">
                            <li className="splide__slide">
                              <div className="image h-100">
                                <div className="we-know-your-pain-list-box text-white d-flex flex-column">
                                  <div className="we-know-your-pain-list-box-icon">
                                    <img
                                      src="https://42works.net/wp-content/uploads/2024/09/2-1.svg"
                                      alt="Goal"
                                    />
                                  </div>{" "}
                                  <div className="we-know-your-pain-list-box-title mb-1">
                                    You have
                                  </div>
                                  <div className="we-know-your-pain-list-box-content">
                                    <p>
                                      <span style={{ fontWeight: "500" }}>
                                        to develop a cohesive brand identity.
                                      </span>
                                    </p>
                                  </div>
                                </div>
                            ...
                            <li className="splide__slide">
                              <div className="image h-100">
                                <div className="we-know-your-pain-list-box text-white d-flex flex-column">
                                  <div className="we-know-your-pain-list-box-icon">
                                    <img
                                      src="https://42works.net/wp-content/uploads/2024/09/1-3.svg"
                                      alt="icon"
                                    />
                                  </div>{" "}
                                  <div className="we-know-your-pain-list-box-title mb-1">
                            ...
                            <li className="splide__slide">
                              <div className="image h-100">
                                <div className="we-know-your-pain-list-box text-white d-flex flex-column">
                                  <div className="we-know-your-pain-list-box-icon">
                                    <img
                                      src="https://42works.net/wp-content/uploads/2024/09/3-2.svg"
                                      alt="Deadlines"
                                    />
                                  </div>{" "}
                                  <div className="we-know-your-pain-list-box-title mb-1">
                            ...
                            <li className="splide__slide">
                              <div className="image h-100">
                                <div className="we-know-your-pain-list-box text-white d-flex flex-column">
                                  <div className="we-know-your-pain-list-box-icon">
                                    <img
                                      src="https://42works.net/wp-content/uploads/2024/09/4.svg"
                            ...
                            <li className="splide__slide">
                              <div className="image h-100">
                                <div className="we-know-your-pain-list-box text-white d-flex flex-column">
                                  <div className="we-know-your-pain-list-box-icon">
                                    <img
                                      src="https://42works.net/wp-content/uploads/2024/09/5_2.svg"
                            ...
                            <li className="splide__slide">
                              <div className="image h-100">
                                <div className="we-know-your-pain-list-box text-white d-flex flex-column">
                                  <div className="we-know-your-pain-list-box-icon">
                                    <img
                                      src="https://42works.net/wp-content/uploads/2024/10/you-need-to-increase-conversions-efficiently.svg"
                                      alt="Conversions"
                                    />
                                  </div>{" "}
                                  <div className="we-know-your-pain-list-box-title mb-1">
                                  ...
                                  <div className="we-know-your-pain-list-box-content">
                                    <p>to increase conversions efficiently.</p>
                                  </div>
                                </div>
                              </div>
                            </li>
